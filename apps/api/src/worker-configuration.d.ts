/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/api/src/worker-configuration.d.ts` (hash: 5d9286de6512a01f586f67de633a05f6)
// Runtime types generated with workerd@1.20260714.1 2026-07-18 nodejs_compat
interface __BaseEnv_Env {
	IMPORTS: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	ASSETS: Fetcher;
	OKANE_DOKOITTA_REGISTRATION_MODE: "invite";
	OKANE_DOKOITTA_TZ: "Asia/Taipei";
	OKANE_DOKOITTA_IMPORT_RETENTION_DAYS: "90";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OKANE_DOKOITTA_REGISTRATION_MODE" | "OKANE_DOKOITTA_TZ" | "OKANE_DOKOITTA_IMPORT_RETENTION_DAYS">> {}
}
